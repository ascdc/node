...
RUN DEBIAN_FRONTEND=noninteractive && \
	...
	apt-get -y -qq install locales openssh-server pwgen vim wget curl screen sudo git python2.7 make build-essential pkg-config cmake libblkid-dev e2fslibs-dev libboost-all-dev libaudit-dev && \
	locale-gen zh_TW && \
